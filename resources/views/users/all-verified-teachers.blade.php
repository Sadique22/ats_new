    ...
    <section class="course_details_area section_gap classes-body">
        <div class="row">
            ...
            <div class="col-lg-6 course_details_left">
                    ...
                    <div class="col-xs-12 col-sm-4 mb-3 pb-2">
                      <div class="single_course">
                        <div class="course_head" style="background-color: #759aff">
                            <?php
                              $t_id = base64_encode($data->id);
                            ?>
                            <a href="teacher-details/{{$t_id}}">
                              <img class="img-fluid" src="{{asset ('assets/img/logo-white.png')}}" alt="" />
                            </a>
                        </div>
                        <div class="course_content teacher_content" style="border: 1px solid #adcbff">
                          <h4 class="mt-2">
                            <a href="teacher-details/{{$t_id}}"> {{$data->name}} </a>
                          </h4>
                          <div class="author purchase teacher_bio">
                            <h6 class="d-inline-block">
                               <?php $string1 = $data->user_bio ;
                                     $string2 = substr($string1, 0, 85);
                                ?>
                              Bio: {{$string2}}...
                            </h6>
                          </div>
                          <div class="star_ratings">
                            <h6 class="d-inline-block">Rating:</h6>
                            @for($i = 0; $i < 5; $i++)
                              <span class="ml-1">
                           ...
                           <div class="timings qualification">
              ...
              @else
                <h2 class="text-center text-warning">Sorry, No teacher have been registered yet!</h2>
              @endif
            </div>
            <div class="col-lg-3 right-contents">
