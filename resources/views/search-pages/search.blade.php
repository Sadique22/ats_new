    ...
    <section class="course_details_area section_gap classes-body">
        <div class="row">
            ...
            <div class="col-lg-6 course_details_left">
                       ...
                       @if($class->category_image != null && $class->bg_color != null && $class->c_status == 1)
                        ...
                        <div class="course_content">
                            ...
                            <div class="star_ratings">
                                ...
                                @endfor
                                <h6 class="level"><i class="fa fa-signal" aria-hidden="true"></i> Intermediate</h6>
                            </div>
                        </div>
                    </div>
                    </div>
              ...
              @else
                @if(isset($searchtext))
                 {{-- <h2 class="text-center text-warning">Sorry,No Result found for: {{$searchtext}}</h2>--}}
                  <img class="img-fluid mx-auto d-block" src="{{asset('assets/img/result.png')}}">
                @else
                  {{--<h4 class="text-center text-warning">Sorry,No Result found for: <span class="text-primary">Category: {{$cat_name}}, Min-Price:{{$data->minPrice}}, Max-Price:{{$data->maxPrice}}, Rating: {{$data->rating}}</span></h4>--}}
                         ...
                         <div class="card-body top-class-card" id="style-8">
                          @foreach($featured_class as $class)
                            <div>
                              ...
                              @if($class->category_image != null && $class->bg_color != null && $class->c_status == 1)
                              <a href="/class-detail/{{$c_id}}/{{$t_id}}">
                               <img class="img-fluid mb-3 mr-3"  src="/{{$class->category_image}}"  alt="" style="background-color: {{$class->bg_color}}" width="100" height="80" /> </a>
                              @else
                              <a href="/class-detail/{{$c_id}}/{{$t_id}}">
                               <img class="img-fluid mb-3 mr-3"  src="{{asset('assets/img/other-category.png')}}"  alt="" style="background-color: #cec8ff;" width="100" height="80" /> </a>
                              @endif
